    ...
    (
        ...
        [
            parser.Card(word='handle',
                        ...
                        pron_us='/ˈhændl/',
                        data=[{'definition': 'to deal with a situation, a person, an area of work '
                                             'or a strong emotion',
                               'examples': ['A new man was appointed to handle the crisis.',
                                            ...
                                            'We can handle up to 500 calls an hour at our new '
                                            'offices.',
                                            'We all have to learn to handle stress.',
                                            "‘Any problems?’ ‘Nothing I can't handle.’",
                                            "I've got to go. I can't handle it any more (= deal "
                                            'with a difficult situation).',
                                            'You have to know how to handle yourself in this '
                                            'business (= know the right way to behave).'],
                               'translate': ''},
                              {'definition': 'to touch, hold or move something with your hands',
                               'examples': ['Our cat hates being handled.',
                                            'The label on the box said: ‘Fragile. Handle with '
                                            'care.’'],
                               'translate': ''},
                              {'definition': 'to control a vehicle, an animal, a tool, etc.',
                               'examples': ["I wasn't sure if I could handle such a powerful car.",
            ...
            parser.Card(word='handle',
                        ...
                        data=[{'definition': 'to deal with a situation, a person, an area of '
                               ...
                               'examples': ['A new man was appointed to handle the crisis.',
                                            ...
                                            'This matter has been handled very badly.',
                                            "“Any problems?” “Nothing I can't handle.”",
                                            "I have to go. I can't handle it anymore (= deal with "
